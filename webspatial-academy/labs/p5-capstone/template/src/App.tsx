  ...
  return (
    <div className="page">
      ...
      <section id="vendors" className="vendors">
        {vendors.map((v) => (
          <article key={v.id} className="vendor pico-panel">
            ...
            <button className="pico-btn pico-btn--ghost" type="button" onClick={() => setSelected(v)}>
              Stall {v.stall}
            </button>
          </article>
        ))}
      ...
      <section id="visit" className="visit pico-panel">
