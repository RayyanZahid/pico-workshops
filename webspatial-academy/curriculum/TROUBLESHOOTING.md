...
| A lab's web app closes by itself a few seconds after launch (emulator at `hw.ramSize=4096`) | Android's low-memory killer: other web apps are still resident (p4 was killed 12 s after launch) | **Close other web apps before launching a lab**; or give the emulator more RAM | VERIFIED 2026-09-24 |
| The page is cut off at the bottom of its window | On PICO OS 6.0.0 windows opened at 1280×720 regardless of `xr_main_scene.default_size` / `initScene` sizes | Design lab pages to fit 1280×720 without scrolling | VERIFIED 2026-09-24 (observed) |
